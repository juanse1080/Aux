# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-04-30 19:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etiology', models.CharField(choices=[(1, 'congenito'), (2, 'oncologico'), (3, 'traumatico')], max_length=10)),
                ('zone', models.CharField(choices=[(1, 'craneo'), (2, 'superior'), (3, 'media'), (4, 'inferior')], max_length=10)),
                ('evolution', models.CharField(choices=[(1, 'agudo'), (2, 'subagudo'), (3, 'cronico')], max_length=10)),
